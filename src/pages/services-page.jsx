                ...
                <div className='services'>
                    <Card image={Computer} 
                        name='Web Development'
                         details = {
                             `We make use of the MERN (Mongodb Express React Node) Stack to make responsive, fast and affordable websites for your
                    ...
                    <Card 
                        ...
                        details = {`We are a top mobile app development company 
                        that would provide you with a great  app development services 
                         to build next-gen mobile applications using  React Native. With about 5 billion mobile users in the world current, we know  
                    ...
                    <Card image={Shop} 
                         details = {`With demand for E-Commerce websites on the rise,  we understand the need for
